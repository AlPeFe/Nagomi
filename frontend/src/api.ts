...
export const api = {
  ...
  async createVehicle(body: { name: string; code?: string; externalCode?: string; vehicleType?: VehicleType; isActive?: boolean; plate?: string; capacity?: number; notes?: string }) {
    return await request<Vehicle>('/admin/vehicles', { method: 'POST', body: JSON.stringify(body) })
  },
  async updateVehicle(id: string, body: { name: string; code?: string; externalCode?: string; vehicleType?: VehicleType; isActive?: boolean; plate?: string; capacity?: number; notes?: string }) {
