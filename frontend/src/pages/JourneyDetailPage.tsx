...
import { api } from '../api'
import { VehicleCell } from '../components/JourneyTable'
...
export function JourneyDetailPage() {
  ...
  return <div className="page detail-page">
      ...
      {mutable && <section className="detail-card"><h2>Operación manual</h2>
        <div className="manual-ops">
          <div className="manual-ops-block">
            <div className="vehicle-detail"><span>Vehículo</span><VehicleCell journey={journey} /><button className="button button-secondary button-small" type="button" onClick={() => setAssigning(true)}>Asignar / adjudicar</button>{!journey.vehicleAdjudicated && journey.vehicleId && <small className="muted">Asignado sin adjudicar: no se ha publicado al proveedor.</small>}</div>
    ...
    {assigning && journey && <JourneyAssignmentPanel
      journey={journey}
      vehicles={vehicles}
